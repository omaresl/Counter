...
#define APP_COUNTERPRACTICE_COUNTER_MIN_VALUE		0x00u
#define APP_COUNTERPRACTICE_COUNTER_MAX_VALUE		0x09u
#define APP_COUNTERPRACTICE_COUNTER_RESET_VALUE		APP_COUNTERPRACTICE_COUNTER_MIN_VALUE

#define APP_COUNTERPRACTICE_7SEG_A_PIN_NUMBER		6u
#define APP_COUNTERPRACTICE_7SEG_B_PIN_NUMBER		5u
#define APP_COUNTERPRACTICE_7SEG_C_PIN_NUMBER		3u
#define APP_COUNTERPRACTICE_7SEG_D_PIN_NUMBER		0u
#define APP_COUNTERPRACTICE_7SEG_E_PIN_NUMBER		7u
#define APP_COUNTERPRACTICE_7SEG_F_PIN_NUMBER		10u
#define APP_COUNTERPRACTICE_7SEG_G_PIN_NUMBER		11u
#define APP_COUNTERPRACTICE_7SEG_DOT_PIN_NUMBER		4u
...
void app_CounterPractice_Init(void)
{
	...
	GPIO_PinInit(GPIOC, 7U,  &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 0U,  &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 3U,  &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 4U,  &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 5U,  &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 6U,  &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 10U, &ls_GPIOPinConfig);
	GPIO_PinInit(GPIOC, 11U, &ls_GPIOPinConfig);
...
static void app_CounterPractice_Byte2BCD(T_UBYTE* lpub_Data, T_UBYTE* lpub_Uni, T_UBYTE* lpub_Ten, T_UBYTE* lpub_Hun)
{
	...
	*lpub_Hun = lub_Data / 100u;
	...
	/* Get Tens */
	lub_Data -= (*lpub_Hun * 100);
	*lpub_Ten = lub_Data / 10u;

	/* Get Units */
	lub_Data -= (*lpub_Ten * 10);
	*lpub_Uni = lub_Data;
}
